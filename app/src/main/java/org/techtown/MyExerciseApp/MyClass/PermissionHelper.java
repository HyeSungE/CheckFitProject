...
public class PermissionHelper {
    ...
    public void requestPermission(){
        ...
        if(ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.CAMERA)) {
            showRetryPermissionsDialog("카메라");
        ...
        ||ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            showRetryPermissionsDialog("사진 및 동영상");
        }else{
            //처음 요청하는 경우 그냥 권한 요청
    ...
    private void showRetryPermissionsDialog(String permissionName) {
        AlertDialog.Builder localBuilder = new AlertDialog.Builder(context);
        localBuilder.setTitle("[ "+permissionName+" ] 권한 설정")
                .setMessage("[ "+permissionName+" ] 권한 거절로 인해 \n일부기능이 제한됩니다.")
